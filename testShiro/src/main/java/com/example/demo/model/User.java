...
import com.example.demo.common.annotation.ExportConfig;
...
public class User implements Serializable {
	...
	public String toString() {
		return "User{" + "userId=" + userId + ", username='" + username + '\'' + ", password='" + password + '\'' + ", deptId=" + deptId
				+ ", deptName='" + deptName + '\'' + ", email='" + email + '\'' + ", mobile='" + mobile + '\'' + ", status='" + status + '\''
				+ ", crateTime=" + crateTime + ", modifyTime=" + modifyTime + ", lastLoginTime=" + lastLoginTime + ", ssex='" + ssex + '\''
				+ ", theme='" + theme + '\'' + ", avatar='" + avatar + '\'' + ", description='" + description + '\'' + ", roleName='" + roleName
				+ '\'' + '}';
	}
